...
function privacy_policy() {
  return (
    <div>
      ...
      <p>
        Dipesh Joshi built the TravMing app as an Open Source app. This SERVICE
        is provided by Dipesh Joshi at no cost and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at TravMing unless otherwise
      ...
      <p>
        ...
        but not limited to username, email, password, mobile number, date of
        birth. The information that I request will be retained on your device
      ...
      <p>This policy is effective as of 2022-07-24</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at joshidipesh122@gmail.com.
      </p>
      <p>
