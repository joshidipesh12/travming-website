      ...
      <section className={`${styles.section} ${styles.section_1}`}>
        ...
        <div className={styles.div_1}>
          <motion.div
            ...
            <p>
              Book all kind of national or international ticket for your next
              destinaion.
            </p>
          </motion.div>
          <motion.div
            ...
            <p>
              Easily surf your according to your budget hotel from top websites.
            </p>
          </motion.div>
          <motion.div
            initial={{x: -100, opacity: 0}}
            ...
            <p>Find yourself the best plan within a short time explore more.</p>
          </motion.div>
        </div>
      </section>
      <section className={`${styles.section} ${styles.section_2}`}>
        <h2 className={styles.h2}>
          There is so much more to explore, just step outside and we are there
          to facilitate.
        </h2>
